...
output "password_policy" {
  description = "Password Policy for the AWS Account. `exprire_passwords` indicates whether passwords in the account expire. Returns `true` if `max_password_age` contains a value greater than 0."
